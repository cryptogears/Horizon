...
const gint64 horizon_post_get_time (const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_get_post_number (const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_get_renamed_filename(const HorizonPost *post) G_GNUC_PURE;
...
const gint64 horizon_post_get_thumbnail_width (const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_get_thumbnail_height (const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_get_width (const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_get_height (const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_get_fsize (const HorizonPost *post) G_GNUC_PURE;
const gboolean horizon_post_has_image (const HorizonPost *post) G_GNUC_PURE;
const gint horizon_post_get_sticky (const HorizonPost *post) G_GNUC_PURE;
const gint horizon_post_get_closed (const HorizonPost *post) G_GNUC_PURE;
const gint horizon_post_get_deleted (const HorizonPost *post) G_GNUC_PURE;
const gint horizon_post_get_spoiler (const HorizonPost *post) G_GNUC_PURE;
const gboolean horizon_post_is_gif (const HorizonPost *post) G_GNUC_PURE;
...
const gint64 horizon_post_get_thread_id(const HorizonPost *post) G_GNUC_PURE;
const gint64 horizon_post_set_thread_id(HorizonPost *post, const gint64 id);

const gboolean horizon_post_set_rendered (HorizonPost *post, const gboolean rendered);
const gboolean horizon_post_is_rendered (const HorizonPost *post) G_GNUC_PURE;
const gboolean horizon_post_is_same_post (const HorizonPost *left, const HorizonPost *right) G_GNUC_PURE;
const gboolean horizon_post_is_not_same_post (const HorizonPost *left, const HorizonPost *right) G_GNUC_PURE;
#endif
